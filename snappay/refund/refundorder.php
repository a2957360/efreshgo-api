<?php
	...
	if(!isset($_REQUEST['refund_amount']) || !isset($_REQUEST['out_refund_no']) || !isset($_REQUEST['out_order_no']) || !isset($_REQUEST['merchant_no'])){
		echo 'refund_amount, out_refund_no, out_order_no and merchant_no can\'t be null'; 
	}else{
